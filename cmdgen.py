...
if __name__ == '__main__':
    ...
    parser.add_argument('--pp', type=str, default='before', choices=['before', 'pam', 'cam', 'pam,cam', 'before,pam', 'before,cam', 'before,pam,cam', 'layer5', 'after', 'all_layers'], help='penalty position')
