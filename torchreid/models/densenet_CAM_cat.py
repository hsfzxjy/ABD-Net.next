...
__all__ = ['densenet121_CAM_cat', 'densenet121_CAM_cat_fc512']
...
def densenet121_CAM_cat(num_classes, loss, pretrained='imagenet', **kwargs):
...
def densenet121_CAM_cat_fc512(num_classes, loss, pretrained='imagenet', **kwargs):
