...
beta=1e-6 nohup python train_reg.py --root data -s market1501 -t market1501 -j 4 --height 256 --width 128 --optim adam --label-smooth --lr 0.0003 --max-epoch 40 --stepsize 20 40 --fixbase-epoch 10 --open-layers classifier fc  --train-batch-size 32 --test-batch-size 100 -a densenet121_nofc_fd_none_nohead_dan_cam_pam_head --save-dir 1214_log/densenet121_nofc_fd_none_nohead_dan_cam_pam_head_xent_reg_svdo_1e-6_40_10 --gpu-devices 7 --criterion xent --regularizer svdo --switch-loss 15 &

beta=1e-6 nohup python train_reg.py --root data -s market1501 -t market1501 -j 4 --height 256 --width 128 --optim adam --label-smooth --lr 0.0003 --max-epoch 40 --stepsize 20 40 --fixbase-epoch 10 --open-layers classifier fc  --train-batch-size 32 --test-batch-size 100 -a densenet121_nofc_fd_none_nohead_dan_cam_pam_nohead --save-dir 1214_log/densenet121_nofc_fd_none_nohead_dan_cam_pam_nohead_xent_reg_svdo_1e-6_40_10 --gpu-devices 7 --criterion xent --regularizer svdo --switch-loss 15 &
