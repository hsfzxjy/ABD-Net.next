...
def get_param(input_fn, layer):
    ...
    a = ['-i', osp.abspath(input_fn), '-p', osp.abspath(path), '-l', str(layer), '-w', '../0111_cluster_pre_log/densenet121_fc512_fd_none_head_dan_none_head_xent_singular_1e-9_60_10_size_256_fcl_sl15__0/checkpoint_ep60.pth.tar']
    _, dir, name = input_fn.split('/')
