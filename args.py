...
def argument_parser():
    ...
    parser.add_argument('--data-augment', type=str, nargs='+', default=['crop'])
    # ************************************************************
    # Video datasets
    # ************************************************************
    ...
    parser.add_argument('--abd-no-reduction', action='store_true')
    ...
    parser.add_argument('--of-type', type=str, choices=['SO', 'SRIP', 'SVDO', 'DSO'], default='SVDO')
