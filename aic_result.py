...
from torchreid.eval_metrics import evaluate, inference
...
def test(model, queryloader, galleryloader, use_gpu, ranks=[1, 5, 10, 20], return_distmat=False):
    ...
    with torch.no_grad():
        ...
        if os.environ.get('save_feat'):
            ...
            io.savemat(os.environ.get('save_feat'), {'q': qf.data.numpy(), 'g': gf.data.numpy(), 'q_target': q_pids, 'g_target': g_pids})
            # return
